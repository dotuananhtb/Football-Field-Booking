                                            ...
                                            <section class="login-register pt-6 pb-6">
                                                <div class="container d-flex align-items-center justify-content-center min-vh-100">
                                                    <div class="log-main blog-full log-reg w-50">
                                                        <h2 class="text-center border-b pb-2">Đặt lại mật khẩu</h2>
                                                        <form method="post" action="${pageContext.request.contextPath}/resetPassword" name="contactform" id="contactform4">
