<%-- 
    Document   : dangki
    Created on : May 27, 2025, 9:03:23 AM
    Author     : Đỗ Tuấn Anh
--%>
        ...
        <div class="log-main blog-full log-reg w-75 mx-auto">
            <div class="row">
                ...
                <div class="col-lg-6 ps-4">
                    ...
                    <div method="get" action="dang-ki"  id="dangkiForm">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="radio" id="gender" name="gender" value="Nam" checked> Nam<br>
                            <input type="radio" id="gender" name="gender" value="Nữ"> Nữ<br>
                        </div>
                        <div class="form-group mb-2">
                        ...
                        <!--<div class="form-group mb-2 d-flex">
                            ...
                            <label class="custom-control-label mb-0 ms-1 lh-1" for="exampleCheck">Tôi đồng ý với điều
                                khoản & dịch vụ của sân?</label>
                        </div>-->
                        <div class="comment-btn mb-2 pb-2 text-center border-b">
                            <input type="submit" class="nir-btn" id="submit" value="Đăng kí" form="dangkiForm">
                        </div>
                        <p class="text-center">Bạn đã có tài khoản? <a href="login.html" class="theme">Đăng nhập</a></p>
                        </form>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <form method="post" action="#" name="contactform1" id="contactform1">
                                        ...
                                        <div class="form-group mb-2 d-flex">
                                            ...
                                            <label class="custom-control-label mb-0 ms-1 lh-1" for="exampleCheck2">I
