                                                                        ...
                                                                        <div class="swiper-wrapper">
                                                                            <div class="slider-home1 relative overflow-hidden swiper-slide">
                                                                                <div class="silider-image">
                                                                                    <img src="./assets/images/slide/sanold.jpg" alt="Image" class="image-slide">
                                                                                    ...
                                                                                    <div class="tf-container">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-8">
                                                                                                ...
                                                                                                <h1 class="title-slide text-white mb-32 fadeInDown wow">Thế Giới Của Tín Đồ Yêu
                                                                                                    <span class="animationtext clip text-main">
                                                                                                        <span class="cd-words-wrapper">
                                                                                                            <span class="item-text is-visible"> Bóng Đá </span>
                                                                                                            <span class="item-text is-hidden">Bóng Đá</span>
                                                                                                        </span>                                          
                                                                                                    </span>
                                                                                                </h1>
                                                                                                <p class="des text-white mb-45 fadeInDown wow">Chào mừng tới Football Star, chúng tôi cung cấp dịch vụ đặt sân bóng đá chuyên nghiệp ở cả 3 miền Tổ quốc 
                                                                                                </p>
                                                                                                <div class="btn-group">
                                                                                                    <a href="#" class="btn-main fadeInDown wow">
                                                                                                        <p class="btn-main-text">Đặt Sân Ngay</p>
                                                                                                        <p class="iconer">
                                                                            ...
                                                                            <div class="slider-home1 relative overflow-hidden swiper-slide">
                                                                                <div class="silider-image">
                                                                                    <img src="./assets/images/slide/football.jpg" alt="Image" class="image-slide">
                                                                                    ...
                                                                                    <div class="tf-container">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-8">
                                                                                                ...
                                                                                                <p class="des text-white mb-45 fadeInDown wow">Chào mừng tới Football Star, chúng tôi cung cấp sản phẩm về bóng đá chất lượng ở cả 3 miền Tổ quốc 
                                                                                                </p>
                                                                                                <div class="btn-group">
                                                                                                    <a href="#" class="btn-main fadeInDown wow">
                                                                                                        <p class="btn-main-text">Cửa Hàng</p>
                                                                                                        <p class="iconer">
                                                                                                            <i class="icon-arrow-right"></i>
                                                                                                        </p>
                                                                                                    </a>
                                                                            ...
                                                                            <div class="slider-home1 relative overflow-hidden swiper-slide">
                                                                                <div class="silider-image">
                                                                                    <img src="./assets/images/slide/rodri.jpg" alt="Image" class="image-slide">
                                                                                    ...
                                                                                    <div class="tf-container">
                                                                                        <div class="row">
                                                                                            <div class="col-lg-8">
                                                                                                ...
                                                                                                <p class="des text-white mb-45 fadeInDown wow">Chào mừng tới Football Star, chúng tôi cung cấp diễn đàn về bóng đá chất lượng, kết nối những người yêu môn thể thao vua ở mọi miền Tổ quốc 
                                                                                                </p>
                                                                                                <div class="btn-group">
                                                                                                    <a href="#" class="btn-main fadeInDown wow">
                                                                                                        <p class="btn-main-text">Diễn Đàn</p>
                                                                                                        <p class="iconer">
                                                                                                            <i class="icon-arrow-right"></i>
                                                                                                        </p>
                                                                                                    </a>
                                                                                                ...
                                                                                                <img src="./assets/images/avata/3.jpg" alt="Image" class="item">
                                                                                                    <img src="./assets/images/avata/1.jpg" alt="Image" class="item">
                                                                                                        <img src="./assets/images/avata/2.jpg" alt="Image" class="item">
                                                                                                            ...
                                                                                                            <p class="client fadeInUp wow">2,500 đã sử dụng dịch vụ của chúng tôi trong 24 giờ qua</p>
                                                                                                            </div>
                                                                                                            </div>
                                                                                                            <div class="row pt-115">
                                                                                                                <div class="col-lg-6">
                                                                                                                    <div class="travel-video relative">
                                                                                                                        <img src="./assets/images/slide/footballStuff.jpg" alt="Image" class="image-video">


                                                                                                                            <img src="./assets/images/slide/old.jpg" alt="Image"
                                                                                                                                ...
                                                                                                                                <div class="col-lg-6">
                                                                                                                                    <div class="inner-content-about">
                                                                                                                                        ...
                                                                                                                                        <h2 class="title-heading mb-18 fadeInUp wow">Cơ hội lớn để giao lưu & kết bạn</h2>
                                                                                                                                        <p class="des-heading fadeInUp wow">Chào mừng tới Football Star, chúng tôi đơn vị góp phần kết nối những người yêu môn thể thao vua ở mọi miền Tổ quốc </p>
                                                                                                                                        <div class="row mt-27 fadeInUp wow">
                                                                                                                                            <div class="col-sm-6">
                                                                                                                                                <div class="icon-box-style3">
                                                                                                                                                    ...
                                                                                                                                                    <h6 class="title mb-10"><a href="#">Môi trường chuyên nghiệp</a></h6>
                                                                                                                                                    <p class="des">Mọi người dùng dịch vụ của chúng tôi đều được xác minh và thông tin đều được bảo mật an toàn</p>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                            <div class="col-sm-6">
                                                                                                                                                <div class="icon-box-style3">
                                                                                                                                                    ...
                                                                                                                                                    <h6 class="title mb-10"><a href="#">Độ Phổ Biến Rộng Rãi</a></h6>
                                                                                                                                                    <p class="des">Chúng tôi cung cấp dịch vụ ở 4 thành phố lớn của Việt Nam</p>
                                                                                                                                                </div>
                                                                                                                                            </div>
                                                                                                                                        </div>
                                                                                                                                        ...
                                                                                                                                        <div class="flex-three btn-wrap-about mb-30 fadeInUp wow">
                                                                                                                                            <a href="#" class="btn-main">
                                                                                                                                                <p class="btn-main-text">Thông Tin Về Chúng Tôi</p>
                                                                                                                                                <p class="iconer">
                                                                                                                                                    <i class="icon-arrow-right"></i>
                                                                                                                                                </p>
                                                                                                                                        ...
                                                                                                                                        <div class="map-check flex-three fadeInUp wow">
                                                                                                                                            ...
                                                                                                                                            <span class="text-main">Đặt Sân Bóng Chưa Bao Giờ Dễ Hơn</span>
                                                                                                                                        ...
                                                                                                                                        <div class="row">
                                                                                                                                            ...
                                                                                                                                            <div class="col-lg-12">
                                                                                                                                                ...
                                                                                                                                                <div class="center m0-auto w-text-heading">
                                                                                                                                                    <span class="sub-title-heading text-main mb-15 fadeInUp wow">Football Star</span>
                                                                                                                                                    <h2 class="title-heading mb-40 fadeInUp wow">Chúng tôi cung cấp những sân bóng tuyệt vời</h2>
                                                                                                                                                </div>
                                                                                                                                                            ...
                                                                                                                                                            <c:forEach items="${listF}" var="o">
                                                                                                                                                                ...
                                                                                                                                                                <div class="col-sm-6 col-lg-3">
                                                                                                                                                                    ...
                                                                                                                                                                    <div class="tour-listing wow fadeInUp animated "
                                                                                                                                                                        ...
                                                                                                                                                                        <div class="tour-listing-content">
                                                                                                                                                                            <span class="tag-listing">${o.status}</span>
                                                                                                                                                                            <span class="map"><i class="icon-Vector4"></i>United States
                                                                                                                                                                                USA</span>
                                                                                                                                                                            <h3 class="title-tour-list"><a href="tour-single.html">${o.field_name}</a>
                                                                                                                                                                            </h3>
                                                                                                                                                                            <div class="review">
                                                                                                                                                                                <i class="icon-Star"></i>
                                                                                                                                                                                <i class="icon-Star"></i>
                                                                                                                                                                            ...
                                                                                                                                                                            <div class="flex-two">
                                                                                                                                                                                <div class="price-box flex-three">
                                                                                                                                                                                    ...
                                                                                                                                                                                    <span class="price">${o.description}</span>
                                                                                                                                                                                </div>
                                                                                                                                                                                <div class="icon-bookmark">
                                                                                                                                                                                    <i class="icon-Vector-151"></i>
                                                                                                                                                                                </div>
