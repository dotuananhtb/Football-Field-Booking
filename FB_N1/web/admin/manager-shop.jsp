                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6 mb-2">
                                    <label for="addColors" class="form-label">Màu sắc  <small>(nhiều giá trị, cách nhau bởi dấu phẩy)</small></label>
                                    <input type="text" class="form-control" id="addColors" name="colors" placeholder="Ví dụ: Đỏ, Đen" >
                                </div>
                                <div class="col-md-6 mb-2">
                                    <label for="addSizes" class="form-label">Size  <small>(nhiều giá trị, cách nhau bởi dấu phẩy)</small></label>
                ...
                <div class="modal-content">
                    ...
                    <form action="${pageContext.request.contextPath}/admin/quan-ly-san-pham" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6 mb-2">
                                    <label for="editColors" class="form-label">Màu sắc  <small>(nhiều giá trị, cách nhau bởi dấu phẩy)</small></label>
                                ...
                                <div class="col-md-6 mb-2">
                                    <label for="editSizes" class="form-label">Size  <small>(nhiều giá trị, cách nhau bởi dấu phẩy)</small></label>
