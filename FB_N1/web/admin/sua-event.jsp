                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                <div class="mb-4">
                                    ...
                                    <form action="${pageContext.request.contextPath}/admin/sua-chu-de" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row g-4">
                                            <div class="col-lg-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="example-palaceholder" name="title_content" class="form-control" placeholder="Tên chủ đề" value="${requestScope.event.title_content}" required>
                                                </div>

                                                <div class="mb-3">
                                                    <label for="example-palaceholder" class="form-label">Mô tả 1</label>
                                                    <input type="text" id="example-palaceholder" name="content1" class="form-control" value="${requestScope.event.content1}" placeholder="Mô tả 1"required>
                                                </div>

                                                <div class="mb-3">
                                                    <label for="example-palaceholder" class="form-label">Mô tả 2</label>
                                                    <input type="text" id="example-palaceholder"name="content2" class="form-control" value="${requestScope.event.content2}" placeholder="Mô tả 2"required>
                                                </div>
                                                <div class="mb-3">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" id="example-palaceholder" name="title1" class="form-control" value="${requestScope.event.title.title1}" placeholder="Tiêu đề 1"required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="example-palaceholder" class="form-label">Tiêu đề 2</label>
                                                    <input type="text" id="example-palaceholder" name="title2" class="form-control" value="${requestScope.event.title.title2}" placeholder="Tiêu đề 2"required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="example-palaceholder" class="form-label">Tiêu đề 3</label>  
                                                    <input type="text" id="example-palaceholder" name="title3" class="form-control" value="${requestScope.event.title.title3}" placeholder="Tiêu đề 3"required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="example-palaceholder" class="form-label">Tiêu đề 4</label>
                                                    <input type="text" id="example-palaceholder" name="title4" class="form-control" value="${requestScope.event.title.title4}" placeholder="Tiêu đề 4"required>
                                                </div>
