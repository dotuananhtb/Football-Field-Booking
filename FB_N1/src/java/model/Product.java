...
public class Product {
    ...
    public Product(int productId, int productCateId, String productName, BigDecimal productPrice, String productImage, String productDescription, String productStatus) {
